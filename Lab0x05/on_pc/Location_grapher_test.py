...
data_Euler = pd.read_csv("Euler_Angle.csv", header=None, names=["EulerAngle", "YawRate", "x-coords", "y-coords"])
...
# Plot
plt.figure()
plt.plot(data_Euler["x-coords"], data_Euler["y-coords"])
plt.title("Global Romi Position")
